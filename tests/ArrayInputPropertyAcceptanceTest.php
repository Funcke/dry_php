...
it(
    'accepts a valid schema', function () {
        $thrown = false;
        try {
...
it(
    'accepts optional fields to be misssing', function () {
        $thrown = false;
        try {
...
it(
    'displays errors in array properties', function () {
        $data_array = ["age" => 7, "book" => (object) ["title" => "example"], "buyers" =>[
        (object)[
            "address" => "Richard"
        ],
...
it(
    'displays wrong value in array field', function () {
        $data_array = ["age" => 7, "book" => (object) ["title" => "example"], "buyers" =>[
        (object)[
            "name" => 2
        ],
