 ...
 * Trait Utility
 * @package Dry\Schema
 * This trait contains utility methods used to centralize the validation work of the DryStruct.
 */
trait Utility {
    /**
     * Methods provides an array of closures associated with the validation work of a constraint. The validation methods
     * can be addressed by the name of the constraint they help assuring.
